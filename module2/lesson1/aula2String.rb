...
p a.include?("itemname")

p a.reverse

p a.reverse! # use ! at the end to change the original array

p a.shuffle

p a.push(30) # will append new element 30 to the end array

a << 25 # << known as shovel operator will also append new element to the end of the array

p a.unshift("someelement") # will add element "some element" to the beginning of the array

p a.pop # will remove the last element of the array and return 1

p a.uniq # will remove all the duplicates and display (will not change the original array)

p a.uniq! # will remove all the duplicates in the original array
...
a.each do |randomvariablename| # starts the do block
...
#a.each { |randomvariablename| puts "Hello #{randomvariablename.capitalize}" }
